...
export function renderThemeFilterBar(themes) {
  ...
  return `<section class="rm-theme-filterbar" aria-label="Explore roadmap by theme" data-enhance-control hidden><div class="rm-theme-filter-heading"><strong>Explore by theme</strong><p class="rm-count" data-roadmap-count role="status" aria-live="polite"></p><button type="button" data-roadmap-clear disabled>Clear filters</button></div><div class="rm-theme-choices" role="group" aria-label="Theme filters">${buttons}</div></section>`;
}
